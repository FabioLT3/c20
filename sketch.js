...
path=createSprite(width/2,height/4);
...
function createCash() {
  if (World.frameCount % 200 == 0) {
   //Modificar las posiciones del dinero 
    var cash = createSprite(random(width/9.9,width/1.1),40, 10, 10);
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(random(width/9.9,width/1.1),40, 10, 10);
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(random(width/9.9,width/1.1),40, 10, 10);
...
function createSword(){
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(random(width/9.9,width/1.1),40, 10, 10);
